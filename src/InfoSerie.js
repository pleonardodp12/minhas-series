...
const InfoSerie = ({ match }) => {
    ...
    useEffect(() => {
        if (match.params.id) {
            axios.get('/api/series/' + match.params.id).then(res => {setData(res.data)
                setForm(res.data)
            })
        }     
    }, [match.params.id])
    ...
    const save = () => {
        axios.put('/api/series/' + match.params.id, {...form, genre_id: genreId }).then(res =>{ setSucess(true) })
    }
    if (sucess) {
                ...
                <div className='container'>
                    ...
                    <form>
                        ...
                        <div className='form-group'>
                            ...
                            <input type='text' value={form.comments} onChange={onChange('comments')} className='form-control' id='name' placeholder='Adicione comentários'/>
                        </div>
                        <div className='form-group'>
